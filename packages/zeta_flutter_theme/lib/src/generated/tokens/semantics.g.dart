...
/// * Dark Mode: #bbc1cb
///
/// Default high contrast (AAA) value is `cool.shade70`
///
/// * Light Mode: #545963 
/// * Dark Mode: #bbc1cb
...
@override
Color get chart2Primary => primitives.green.shade60;
@override
Color get chart2Secondary => primitives.green.shade40;
@override
Color get chart3Primary => primitives.orange.shade50;
@override
Color get chart3Secondary => primitives.orange.shade30;
@override
...
@override
Color get chart8Primary => primitives.cool.shade90;
@override
Color get chart8Secondary => primitives.cool.shade70;
@override
Color get avatarBlue => primitives.blue.shade80;
@override
...
@override
List<Object?> get props => [mainDefault, mainSubtle, mainPrimary, mainSecondary, mainPositive, mainWarning, mainNegative, mainInfo, mainDisabled, mainLight, mainInverse, borderDefault, borderSelected, borderHover, borderSubtle, borderDisabled, borderPure, borderPrimaryMain, borderPrimary, borderSecondary, borderPositive, borderWarning, borderNegative, borderInfo, surfaceDefault, surfaceDefaultInverse, surfaceHover, surfaceSelected, surfaceSelectedHover, surfaceDisabled, surfaceCool, surfaceWarm, surfacePrimary, surfacePrimarySubtle, surfaceSecondary, surfaceSecondarySubtle, surfacePositive, surfacePositiveSubtle, surfaceWarning, surfaceWarningSubtle, surfaceNegative, surfaceNegativeSubtle, surfaceInfo, surfaceInfoSubtle, stateDisabledDisabled, stateDefaultEnabled, stateDefaultHover, stateDefaultSelected, stateDefaultFocus, statePrimaryEnabled, statePrimaryHover, statePrimarySelected, statePrimaryFocus, stateNegativeEnabled, stateNegativeHover, stateNegativeSelected, stateNegativeFocus, stateSecondaryEnabled, stateSecondaryHover, stateSecondarySelected, stateSecondaryFocus, stateInfoEnabled, stateInfoHover, stateInfoSelected, stateInfoFocus, stateInverseEnabled, stateInverseHover, stateInverseSelected, stateInverseFocus, statePositiveEnabled, statePositiveHover, statePositiveSelected, statePositiveFocus, chart1Primary, chart1Secondary, chart2Primary, chart2Secondary, chart3Primary, chart3Secondary, chart4Primary, chart4Secondary, chart5Primary, chart5Secondary, chart6Primary, chart6Secondary, chart7Primary, chart7Secondary, chart8Primary, chart8Secondary, avatarBlue, avatarGreen, avatarOrange, avatarPink, avatarPurple, avatarTeal, avatarYellow,];
}
...
@override
Color get chart2Primary => primitives.green.shade90;
@override
Color get chart2Secondary => primitives.green.shade70;
@override
Color get chart3Primary => primitives.orange.shade90;
@override
Color get chart3Secondary => primitives.orange.shade70;
@override
...
@override
List<Object?> get props => [none, minimum, small, medium, large, xl, xl_2, xl_3, xl_4, xl_5, xl_6, xl_7, xl_8, xl_9, xl_10, xl_11,];
}
