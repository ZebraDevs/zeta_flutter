...
class _ZetaTopAppBarState extends State<ZetaTopAppBar> {
  ...
  Widget _getTitle(ZetaSemanticColors colors) {
        ...
        Row(
          ...
          children: [
            Semantics(
              ...
              button: true,
              child: IconButton(
                color: colors.primitives.cool.shade50,
            ...
            if (widget.onSearchMicrophoneIconPressed != null) ...[
              SizedBox(
                ...
                child: VerticalDivider(width: ZetaBorders.medium, color: colors.primitives.cool.shade70),
              ),
              Semantics(
