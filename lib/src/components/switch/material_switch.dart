...
class _SwitchDefaultsM3 extends SwitchThemeData {
  ...
  WidgetStateProperty<Color> get thumbColor {
    return WidgetStateProperty.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.disabled)) {
        if (states.contains(WidgetState.selected)) {
          return _colors.surface.setOpacity(1);
        }
        return _colors.onSurface.setOpacity(0.38);
      }
      if (states.contains(WidgetState.selected)) {
  ...
  WidgetStateProperty<Color> get trackColor {
    return WidgetStateProperty.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.disabled)) {
        if (states.contains(WidgetState.selected)) {
          return _colors.onSurface.setOpacity(0.12);
        }
        return _colors.surfaceContainerHighest.setOpacity(0.12);
      }
      if (states.contains(WidgetState.selected)) {
        if (states.contains(WidgetState.pressed)) {
  ...
  WidgetStateProperty<Color?> get overlayColor {
    return WidgetStateProperty.resolveWith((Set<WidgetState> states) {
      if (states.contains(WidgetState.selected)) {
        if (states.contains(WidgetState.pressed)) {
          return _colors.primary.setOpacity(0.12);
        }
        if (states.contains(WidgetState.hovered)) {
          return _colors.primary.setOpacity(0.08);
        }
        if (states.contains(WidgetState.focused)) {
          return _colors.primary.setOpacity(0.12);
        }
      ...
      if (states.contains(WidgetState.hovered)) {
        return _colors.onSurface.setOpacity(0.08);
      }
      if (states.contains(WidgetState.focused)) {
        return _colors.onSurface.setOpacity(0.12);
      }
