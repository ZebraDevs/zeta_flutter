...
abstract interface class ZetaSizeSemantics {
  /// None space
  double get none;
...
final class ZetaSizeAA implements ZetaSizeSemantics {
  /// Constructor for ZetaSizeAA
  const ZetaSizeAA({required this.primitives});
...
final class ZetaSizeAAA implements ZetaSizeSemantics {
  /// Constructor for ZetaSizeAAA
  const ZetaSizeAAA({required this.primitives});
...
class ZetaSemanticsAA implements ZetaSemantics {
  ...
  ZetaSemanticsAA({required this.primitives})
      : colors = ZetaColorAA(primitives: primitives),
        size = ZetaSizeAA(primitives: primitives),
...
class ZetaSemanticsAAA implements ZetaSemantics {
  ...
  ZetaSemanticsAAA({required this.primitives})
      : colors = ZetaColorAAA(primitives: primitives),
        size = ZetaSizeAAA(primitives: primitives),
