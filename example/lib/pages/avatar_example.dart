...
class AvatarExample extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 25),
                avatarImageWithBadgeExample,
                const SizedBox(height: 25),
                avatarInitialsWithBadgeExample,
                const SizedBox(height: 25),
                avatarImageWithSpecialStatusExample,
                const SizedBox(height: 25),
                avatarInitialsWithSpecialStatusExample,
              ],
            ),
          ),
        );
  ...
  static Widget get avatarImageExample => Column(
        children: [
          Text(
            'ZetaAvatar.image',
  ...
  static Widget get avatarInitialsExample => Column(
        children: [
          Text(
            'ZetaAvatar.initials',
            style: TextStyle(fontWeight: FontWeight.bold),
  ...
  static Widget get avatarImageWithBadgeExample => Column(
        children: [
          Text(
  ...
  static Widget get avatarInitialsWithBadgeExample => Column(
        children: [
          Text(
  ...
  static Widget get avatarImageWithSpecialStatusExample => Column(
        children: [
          Text(
  ...
  static Widget get avatarInitialsWithSpecialStatusExample => Column(
        children: [
          Text(
